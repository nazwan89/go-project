...
// LoadAppConfig() is the single point of truth for env-driven configuration.
...
// LoadAppConfig reads configuration from environment variables with safe defaults.
